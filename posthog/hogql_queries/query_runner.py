...
def get_query_runner(
    ...
    # The factory routes to the archive runner when the export requested it (flag-gated
    # at export-creation time).
    if kind == "LogsQuery":
        from products.logs.backend.facade.queries import build_logs_query_runner_for_export

        return build_logs_query_runner_for_export(
            query=query,
            team=team,
            timings=timings,
            modifiers=modifiers,
